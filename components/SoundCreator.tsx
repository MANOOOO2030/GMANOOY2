...
const SoundCreator: React.FC<StorytellerProps> = ({ selectedVoice, audioContext, theme, T, playGreeting, resetTrigger, isActive = true }) => {
    ...
    // Pause all audio when component becomes inactive (e.g., navigating to Live Chat)
    useEffect(() => {
    ...
    return (
        <div className="flex flex-col h-full w-full p-4 space-y-2 overflow-hidden" ref={containerRef}>
